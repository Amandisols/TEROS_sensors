...
plot_battery_percentage <- function(dfList) {
  ...
  if(!dir.exists("plots/battery_percentage")){
    dir.create("plots/battery_percentage")
  }
  ...
  for(i in seq_along(dfList)){
    ...
    ggsave(filename = paste0("plots/battery_percentage/battery_percentage_plot_",df_name,".png"), plot = p, width = 10, height = 5)
  }
  }
